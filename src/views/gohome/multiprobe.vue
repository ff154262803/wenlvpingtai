    ...
    <el-dialog title="新增" :visible.sync="dialogFormVisible">
      <el-form :model="form" ref="form" :rules="rules">
        ...
        <el-form-item label="活动简介" prop="summary" label-width="100px">
          <el-input v-model="form.summary" style="width: 300px" maxlength="20" show-word-limit></el-input>
        </el-form-item>
        ...
        <el-form-item label="缩略图" prop="imgUrl" class="imgurl">
          <el-upload class="avatar-uploader" action="http://192.192.0.241:5005/api/manage/ferriswheel/resources/upload"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addOrModifyTheme('form')">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
