<template>
    <div class="classificationPage">
        <!-- 过滤区 -->
        <el-input placeholder="请输入标题" v-model="query.title" style="width:300px" clearable
                  @clear="queryParkNoticeList"></el-input>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <p style="cursor: pointer" @click="Detail(scope.row)">{{scope.row.content}}</p>
                </template>
            </el-table-column>
            <el-table-column
                prop="starttime"
        ...
        <div class="el-dialog__wrapper" v-show="addBol">
            <div class="el-dialog el-dialogedit">
                <div class="el-dialog__header">
                    ...
                    <button class="el-dialog__headerbtn" aria-label="Close" type="button" @click="reset('')"><i
                ...
                <div class="el-dialog__body">
                    <el-form :model="addData" :rules="rules" ref="addData">
                        ...
                        <el-form-item label="内容" label-width="65px" prop="content">
                            <el-input v-model="addData.content" style="width: 350px"></el-input>
                        </el-form-item>
        ...
        methods: {
            ...
            Del(id) {
                this.$confirm('您确定要删除该类型吗?', '提示', {
                    ...
                    this.$ajax.deleteParkNotice({idlst: this.multipleSelection}, res => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
                        });
