      ...
      <div class="el-dialog">
        ...
        <div class="el-dialog__body">
          ...
          >
            ...
            <el-form-item label="路线信息">
              <div style="height: 400px" id="mymapdetail"></div>
            </el-form-item>
          </el-form>
        </div>
        <div class="el-dialog__footer">
          <div class="dialog-footer">
            <el-button @click="cancel('newdata')">取 消</el-button>
            <el-button type="primary" @click="cancel('newdata')"
              >确 定</el-button
            >
          </div>
        </div>
    ...
    add(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.newdata.id) {
            this.$ajax.updateRoute(
              {
                id: this.newdata.id,
                parameters: {
                  caption: this.newdata.caption,
                  isenable: this.newdata.isenable,
                  lineslist: this.newdata.lineslist,
                  parkid: this.newdata.parkid,
