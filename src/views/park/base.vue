    ...
    <div class="box" v-loading="fullscreenLoading">
      <div class="menu">
        ...
        <el-row class="list" style="height: 80px">
          ...
          <el-upload class="upload" accept="application/zip" :action="$store.state.ip + '/resources/uploadResource'"
            style="display: none" :on-progress="handleLoading" :on-success="onsuccsess" :before-upload="beforeUpload"
          ...
          <el-col :span="2">
            <div class="icon">
              <img src="../../../static/img/del.png" alt="" style="width: 25px" v-show="detail.ardownloadurl != ''"
                @click="deling()" />
    ...
    <el-dialog title="修改折扣期限" :visible.sync="discountperiodShow" class="demo-box" width="590px"
      ...
      <el-form :model="editdata" ref="discountperiod" label-width="100px">
        <el-form-item label="AR折扣" prop="discountperiod">
          <el-date-picker v-model="editdata.discountperiodarr" type="daterange" range-separator="至"
