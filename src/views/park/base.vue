    ...
    <div class="mianbox">
        <div class="box">
            <div class="menu">
                ...
                <el-row class="list">
                    <el-col :span="24">
                        <div><span>ID：</span>{{detail.parkid}}</div>
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="22">
                ...
                <el-row class="list">
                    <el-col :span="22">
                        <div><span>省市：</span>{{detail.province}} - {{detail.city}}</div>
                    </el-col>
                    <el-col :span="2">
                        <div class="icon" @click="edit('city')"><img src="../../../static/img/edit.png" alt=""></div>
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="22">
                    ...
                    <el-col :span="2">
                        <div class="icon" @click="edit('price')"><img src="../../../static/img/edit.png" alt=""></div>
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="22">
                        <div><span>开放时间：</span>{{detail.opentime}} <span v-if="!detail.opentime">例：每年11月至次年3月</span></div>
                    </el-col>
                    <el-col :span="2">
                ...
                <el-row class="list">
                    ...
                    <el-col :span="2">
                        <div class="icon" @click="edit('packnumber')"><img src="../../../static/img/edit.png" alt="">
                        </div>
                    </el-col>
                </el-row>
                <el-row class="list">
        ...
        <div class="box" v-loading="fullscreenLoading">
            <div class="menu">
                ...
                <el-row class="list">
                    ...
                    <el-col :span="2">
                        <div class="icon" @click="edit('arprice')"><img src="../../../static/img/edit.png" alt=""></div>
                    </el-col>
                </el-row>
                <el-row class="list">
                    <el-col :span="22">
                    ...
                    <el-col :span="2">
                        <div class="icon" @click="edit('ardiscount')"><img src="../../../static/img/edit.png" alt="">
                        </div>
                    </el-col>
                </el-row>
                <el-row class="list">
                    ...
                    <el-col :span="2">
                        <div class="icon" @click="edit('discountperiod')"><img src="../../../static/img/edit.png"
                                                                               alt=""></div>
                    </el-col>
                </el-row>
                    ...
                    <el-col :span="2">
                        <div class="icon">
                            <img src="../../../static/img/del.png" alt="" style="width:25px"
                                 v-show="detail.ardownloadurl!=''" @click="deling()">
                            <img src="../../../static/img/upload.png" alt="" v-show="detail.ardownloadurl==''"
                                 @click="uploading()">
                        </div>
                    </el-col>
                </el-row>
        ...
        <div class="box boxr">
            <div class="menu">
                <el-row class="p">
                    ...
                    <el-col :span="14">
                        <div class="btnright">
                            <el-button type="info" plain @click="showchange()" v-show="showedit==false&&redit==false">
                                显示范围修改<span style="color:#fb2a39;">——</span></el-button>
                            <el-button type="info" plain @click="rchange()" v-show="showedit==false&&redit==false">
                                园区范围修改<span style="color:#2a88fb">——</span></el-button>
                            <el-button type="info" plain v-show="showedit==true||redit==true" @click="editcancle">取消
                            </el-button>
                            <el-button type="info" plain v-show="showedit==true||redit==true" @click="editsubmit">确定
                            </el-button>
                        </div>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        ...
                        <el-input type="text" id="tipinput" v-show="showedit==true||redit==true" v-model="tipinput"
                                  placeholder="请输入您想查询的位置名称" style="width:200px"></el-input>
            ...
            <el-form :model="editdata" :rules="detailrules" ref="type" label-width="100px">
                <el-form-item label="分类" prop="type">
                    <el-select v-model="editdata.type">
                        <el-option v-for="item in list" :label="item.typeName" :value="item.id"
            ...
            <el-form :model="editdata" :rules="detailrules" ref="city" label-width="100px">
                <el-form-item label="省市" prop="city">
                    <el-select v-model="editdata.province" @change="selectcity">
                        <el-option v-for="item in area" :label="item.name" :value="item.name"
                                   :key="item.name"></el-option>
                    </el-select>
                    -
                    <el-select v-model="editdata.city">
                        <el-option v-for="item in areacity" :label="item.name" :value="item.name"
                                   :key="item.name"></el-option>
                    </el-select>
                </el-form-item>
            </el-form>
    ...
    export default {
        data() {
            ...
            return {
                ...
                areacity: [],
                detailrules: {
                    caption: [{required: true, message: '请输入园区名', trigger: 'blur'}, {
                        max: 20,
                        message: '最多20个字符',
                        trigger: 'blur'
                    }],
        ...
        methods: {
            ...
            editsubmit() {
                ...
                if (this.redit) {
                    ...
                    this.$ajax.updatePark({
                        id: this.parkid,
                        parameters: {electronicfencelist: JSON.stringify(curpath), lat: marker.lat, lon: marker.lng}
                    }, res => {
                        this.$message({
                            type: 'success',
                            message: '修改成功!'
