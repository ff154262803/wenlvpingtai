<template>
  <div class="classificationPage">
    <!-- 过滤区 -->
    <el-input placeholder="请输入标题" v-model="query.title" style="width: 300px" clearable @clear="queryParkNoticeList">
    </el-input>
    ...
    <div class="screenTime">
      ...
      <el-date-picker v-model="changeTime" type="daterange" range-separator="至" start-placeholder="开始日期"
        end-placeholder="结束日期" value-format="yyyy-MM-dd" @change="clearNullTime">
      </el-date-picker>
    </div>
    <!--表格内容-->
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
      ...
      <el-table-column label="操作" width="150" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="Detail(scope.row, true)">复制重发</el-button>
          <el-button type="text" size="small" @click="seeNew(scope.row)">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!--分页-->
    ...
    <div class="el-dialog__wrapper" v-show="addBol">
      <div class="el-dialog el-dialogedit">
        <div class="el-dialog__header">
          ...
          <button class="el-dialog__headerbtn" aria-label="Close" type="button" @click="reset('')">
        ...
        <div class="el-dialog__body">
          <el-form :model="addData" :rules="rules" ref="addData">
            ...
            <el-form-item label="有效期" label-width="65px" prop="time">
              <el-date-picker v-model="addData.time" type="daterange" range-separator="至" start-placeholder="开始日期"
                end-placeholder="结束日期" value-format="yyyy-MM-dd"></el-date-picker>
            </el-form-item>
            <el-form-item label="内容" label-width="65px" prop="content">
              <el-input v-model="addData.content" style="width: 350px" maxlength="16" placeholder="请输入最多16个字符">
              </el-input>
            </el-form-item>
        ...
        <div class="el-dialog__footer">
          <div class="dialog-footer">
            ...
            <el-button type="primary" v-if="detail1" @click="submit('addData')">确 定</el-button>
          </div>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      UpDown(item) {
        ...
        // this.$ajax.openNotice({  isenable: val },
        //   (res) => {
        //     this.$message({
        //       type: "success",
        //       message: "设置成功!",
