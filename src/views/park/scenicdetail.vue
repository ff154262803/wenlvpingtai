<template>
  <div class="mianbox">
      ...
      <div class="menu">
        ...
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>是否有全景：</span
              >{{ detail.ispanorama == "1" ? "是" : "否" }}
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('ispanorama')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
        ...
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>显示层级：</span>{{ detail.lowlevel }} -
              {{ detail.highlevel }}
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('level')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>特点标签：</span>{{ detail.tag
              }}<span v-if="!detail.tag">可以描述下景点特点</span>
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('tag')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
        <el-row class="list">
          <el-col :span="22">
            <div>
              ...
              }}<span v-if="!detail.opentime">例：每天8:00-19:00</span>
            </div>
          </el-col>
          <el-col :span="2">
        ...
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>咨询电话：</span>{{ detail.phonenumber
              }}<span v-if="!detail.phonenumber">例：010-12345678</span>
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('phonenumber')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>概述：</span>{{ detail.remark
              }}<span v-if="!detail.remark">可以对景点写一段大概描述</span>
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('remark')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
    ...
    <div class="box">
      <div class="menu">
        ...
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>是否AR：</span>{{ detail.isar == "1" ? "是" : "否" }}
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('isar')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
        <div v-show="detail.isar == 1">
          <el-row class="list">
            <el-col :span="22">
              <div>
                <span>最佳时间：</span>{{ detail.besttime
                }}<span v-if="!detail.besttime">简要说明AR观看的最佳时间</span>
              </div>
            </el-col>
            <el-col :span="2">
              <div class="icon" @click="edit('besttime')">
                <img src="../../../static/img/edit.png" alt="" />
              </div>
            </el-col>
          </el-row>
          <el-row class="list">
            ...
            <el-col :span="2">
              <div class="icon" @click="edit('score')">
                <img src="../../../static/img/edit.png" alt="" />
              </div>
            </el-col>
          </el-row>
          <el-row class="list">
            <el-col :span="22">
              <div>
                <span>需要解锁：</span>{{ detail.islock == "1" ? "是" : "否" }}
              </div>
            </el-col>
            <el-col :span="2">
              <div class="icon" @click="edit('islock')">
                <img src="../../../static/img/edit.png" alt="" />
              </div>
            </el-col>
          </el-row>
          <el-row class="list" v-show="detail.islock == 1">
            ...
            <el-col :span="2">
              <div class="icon" @click="edit('unlockcondition')">
                <img src="../../../static/img/edit.png" alt="" />
              </div>
            </el-col>
          </el-row>
          ...
          <el-col :span="14">
            <div class="btnright">
              <el-button
                ...
                >修改AR围栏和位置<span style="color: #2a88fb"
                  >——</span
                ></el-button
              >
              <el-button
      ...
      <div class="menu">
        ...
        <el-row class="list">
          ...
          <el-upload
            ...
            :on-error="onerror"
          >
            <el-button size="small" type="primary" id="upobj"
              >点击上传</el-button
            >
            <div class="el-upload__tip" slot="tip">
              只能上传zip文件，且不超过50M
          ...
          <el-col :span="2">
            <div class="icon">
              <img
                ...
                alt=""
                style="width: 25px"
                v-show="detail.modelurl != ''"
                @click="deling('modelurl')"
              />
              <img
                src="../../../static/img/upload.png"
                alt=""
        ...
        <el-row class="list">
          <el-col :span="22">
            <div>
              <span>详情类型：</span
              >{{ detail.detailstypeName ? detail.detailstypeName : "无" }}
            </div>
          </el-col>
          <el-col :span="2">
            <div class="icon" @click="edit('detailstype')">
              <img src="../../../static/img/edit.png" alt="" />
            </div>
          </el-col>
        </el-row>
    ...
    <el-dialog
      title="修改解锁条件"
      :visible.sync="unlockconditionShow"
      class="demo-box"
      width="590px"
      :close-on-click-modal="false"
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="add('unlockcondition')"
          >确 定</el-button
        >
      </div>
    </el-dialog>
      ...
      >
        <el-form-item label="详情类型" prop="detailstype">
          <el-radio
            v-for="n in linktype"
            :key="n.id"
            v-model="editdata.detailstype"
            :label="n.id"
          >
            {{ n.typeName }}</el-radio
          >
          <el-radio key="0" v-model="editdata.detailstype" label="0"
            >无</el-radio
          >
        </el-form-item>
      </el-form>
...
export default {
  data() {
    ...
    return {
      ...
      detailrules: {
        ...
        lowlevel: [
          { required: true, message: "请选择最低等级", trigger: "change" },
        ],
        tag: [
        ...
        besttime: [
          { required: true, message: "请输入最佳时间", trigger: "blur" },
          { max: 20, message: "最多20个字符", trigger: "blur" },
        ],
  ...
  methods: {
    ...
    onsuccsessmp3(response, file, fileList) {
      this.$ajax.updateSite(
        { id: this.detail.id, parameters: { voiceurl: response.url } },
        (res) => {
          this.$message({
            type: "success",
            message: "修改成功!",
    ...
    onsuccsessmp4(response, file, fileList) {
      this.$ajax.updateSite(
        { id: this.detail.id, parameters: { videourl: response.url } },
        (res) => {
          this.$message({
            type: "success",
            message: "修改成功!",
    ...
    onsuccsessobj(response, file, fileList) {
      this.$ajax.updateSite(
        { id: this.detail.id, parameters: { modelurl: response.url } },
        (res) => {
          this.$message({
            type: "success",
            message: "修改成功!",
    ...
    add(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$ajax.updateSite(
            { id: this.detail.id, parameters: prams },
            (res) => {
              this.$message({
                type: "success",
                message: "修改成功!",
    ...
    enableState(val) {
      ...
      this.$ajax.setSiteEnableState(
        { idlst: [this.siteid], isenable: val },
        (res) => {
          this.$message({
            type: "success",
            message: "设置成功!",
